...
export default function Navbar() {
  ...
  return (
    <div>
      <nav className="block w-full max-w-screen px-4 py-4 mx-auto bg-background bg-opacity-90 sticky top-3 shadow lg:px-8 backdrop-blur-lg backdrop-saturate-150 z-[9999]">
        <div className="container flex flex-wrap items-center justify-between mx-auto text-slate-800">
          <Link
            href="/"
            className="mr-4 block cursor-pointer py-1.5 text-[#028010] font-bold text-2xl"
          >
            OPTOGIANT
          </Link>
          ...
          >
            <div className="flex flex-row items-center border-b pb-4">
              <Link
                href="/"
                className="cursor-pointer text-[#028010] font-bold text-xl pt-4 ps-4"
              >
                OPTOGIANT
              </Link>
              <button
            ...
            <ul className="flex flex-col h-full gap-4 p-4">
              ...
              <li className="mt-4">
                <button className="bg-[#004109] text-white px-8 py-2 rounded-md hover:bg-[#028010]">
                  Login
                </button>
              </li>
            </ul>
          ...
          <div className="hidden lg:block">
            <ul className="flex flex-col gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
              ...
              <li>
                <button className="bg-[#004109] hover:bg-[#028010] cursor-pointer text-white px-8 py-2 rounded-md">
                  Login
                </button>
              </li>
            </ul>
